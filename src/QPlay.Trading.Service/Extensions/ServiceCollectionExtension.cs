...
public static class ServiceCollectionExtension
{
    ...
    public static IServiceCollection ConfigureMassTransit(this IServiceCollection services, IConfiguration configuration)
    {
        services.AddMassTransit(configure =>
        {
            ...
            configure.AddSagaStateMachine<PurchaseStateMachine, PurchaseState>((ctx, sagaConfig) => sagaConfig.UseInMemoryOutbox(ctx))
        ...
        QueueSettings queueSettings = configuration.GetSection(nameof(QueueSettings)).Get<QueueSettings>();
